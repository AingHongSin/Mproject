...
# Calculate
    ...
    def upper(self):
        self.mesUpper = tk.Message(self.Result_frame, text = (f"All the deta is corresponding sum and the data."), width = 450)
        self.mesUpper.pack()
        self.mesSupUpper = tk.Message(self.Result_frame, text = (f"The data is {self.searchVar}. We have :"), width = 450)
        self.mesSupUpper.pack()
        self.check = True
